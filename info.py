...
auth_channel = environ.get('AUTH_CHANNEL', '-1002399683412 -1002456267845')  # Channel/Group ID for force sub (make sure bot is admin)
...
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002399683412 -1002456267845').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/Denu_dhakad')  # How to open tutorial link for verification
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Denu_dhakad')  # Tutorial video link for opening shortlink website
